...
//Get data to plot
		if($_GET['startdate']){
			...
			//get name of each month, calculate income for the month, move to next month till last as selected
				...
				$data[$i]=$revreport->monthlyvisits($hospital,$start, $end);
...
$graph->title->Set("Monthly Patients Visit Between: ". $_GET['startdate']." TO ".$lastdate);
$graph->xaxis->title->Set("Month");
$graph->xaxis->SetTickLabels($legend);
$graph->yaxis->title->Set("No. Of Visits");
