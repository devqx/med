...
$folder = 'img/profiles/';
//$_SESSION['patientID'].
$filename = $_SESSION['patientID'].'_profile.jpg';
//$filename = $_SERVER['REMOTE_ADDR'].rand().'.jpg';
...
rename($original,'img/profiles/'.$filename);
$original = 'img/profiles/'.$filename;
...
echo '{"status":1,"message":"Success!","filename":"'.$filename.'?rand='.rand(0,900).'"}';
