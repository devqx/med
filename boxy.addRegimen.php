	...
	<form id="new_RegimenForm" method="post" action="<?php echo $_SERVER['REQUEST_URI'] ?>">
		...
		<div id="regData">
			<div>
                ...
                <div class="row-fluid">
                    <label class="span4">
                        Dose <input type="text" name="dose" id="dose" placeholder="Dose quantity">
                    </label>


                    <label class="span4" title="Please Enter Numbers Only!"> Frequency
                        <input style="min-width: 10px" type="number" data-decimals="0" name="freqno" id="freqno" placeholder="eg. 3">
                    </label>

                    <label class="span4">Frequency Type
...
<!--					<label class="span3" style="margin-bottom: -5px">Dose <input type="text" name="dose" id="dose" placeholder="Dose quantity"></label>-->
					<label class="span6" title="Please Enter Numbers Only!" >Duration <!--<span style="font-size: 90%; font-style: italic; color: #666"></span>-->
