...
$gynaecological_history_template_id = 3;
$hH = (new HistoryDAO())->byTemplate($gynaecological_history_template_id);
?>
<section>
	<div class="menu-head">Patient Gynaecological History <span class="add1 pull-right"><a href="javascript:;">Add new Record</a></span>
	</div>

	<?php if (count($histories) == 0) { ?><p class="notify-bar">No gynaecological history data
		available</p><?php } else { ?>
