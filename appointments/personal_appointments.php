 ...
 */ ?>
<div class="row-fluid">
	<h4 class="span6">Personal Appointments</h4>
	<label class="span6"><input type="text" name="staff_id" value="<?= isset($_REQUEST['staff_id']) ? $_REQUEST['staff_id'] : "" ?>"></label>
</div>
<?php
...
//                        $(this).css('background-color', 'red');
			...
			eventSources: [
				{
					url: '/functions/appointment_processor.php?getStaffAppointments=true<?= (isset($_GET['staff_id']) ? '&staff_id=' . $_GET['staff_id'] : '') ?>',
					error: function () {
						$('#script-warning').show();
					},
					success: function (d) {
