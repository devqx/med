...
<script type="text/javascript">
	...
	function showTabs(t) {
		if (t === 1) {
			activateTab(t, '/pm/packages/packages.php', 'Add New Promo Offer/Package', '/pages/pm/packages/boxy.addpackage.php');
		}
		else {
		}
	}
...
<div>
	<div id="tabbedPane" style="margin-bottom: -6px;" class="mini-tab">
		<a href="javascript:void(0)" class="tab on" id="tab-1" onClick="showTabs(1)"><span></span> Available Packages</a>
	</div>
