...
if($_POST){
	...
	$centre = (new ServiceCenterDAO())->get($_POST['id'])->setDepartment( new Department($_POST['department_id_']) )->setCostCentre( new CostCenter($_POST['cost_centre_id']) )->setName($_POST['centre_name'])->setType('MedicalReport')->update();
	if($centre !== null){
