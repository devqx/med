...
$lab_centers = (new ServiceCenterDAO())->all('Ophthalmology');
?>
<h5>Available Business Unit/Service Centres <a href="javascript:" class="pull-right" onclick="Boxy.load('/pages/pm/ophth-center-new.php', {title:'New Business Unit/Service Centre'})">New Business Unit/Service Centre</a></h5>
