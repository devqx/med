...
$pageSize = 10;
$temp = (new PatientScanDAO())->getScans($start, $stop, $page, $pageSize, 'scheduled', $patient, $categoryId);
...
?>
	...
	<script type="text/javascript">
		...
		var applyPageFilters = function(page){
			...
			var url = "/imaging/scheduled.php?date=" + encodeURIComponent(date_start) + "," + encodeURIComponent(date_stop) + "&page=" + page;
