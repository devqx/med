  ...
  (function($) {
    ...
    lockScreen = {
      ...
      updateHtml: function() {
        ...
        this.$unlockMe.addClass(this.config.unlockBtnClass);
    ...
    $.fn.lockScreen = function(config) {
      ...
      return this.each(function() {
        ...
        $('.unlock-me').bind('click', function() {
          if (typeof config.unlock === 'function') {
            config.unlock();
          }
        });
      });
    ...
    return $.fn.lockScreen.defaults = {
      ...
      unlockBtnClass: "",
      template: '<div class="lock-screen" style="display: none"> <div class="current-user"> <h2><img alt="" src="" class="logo"></h2> <span><img alt="" height="80" src="" width="80"></span> <h4></h4> <input autofocus="" class="password-field" placeholder="" type="password"> <button class="unlock-me"></button> </div> </div>'
    };
  })(jQuery);
