...
//$protect = new Protect();
$report = (new PatientProcedureDAO())->get($_GET['id']);
...
<div class="container">
	...
	<table class="box table table-condensed table-borderless">
		...
		<tr>
			...
			<td>Request Date:</td>
			<td><?= date("dS M, Y h:i A", strtotime($report->getReports()[0]->getRequestTime())) ?></td>
		</tr>
		<tr>
			<td>Coverage:</td>
	...
	<?php foreach ($report->getReports() as $note) {
		?>
		<div class="box">
			<div class="row-fluid">
				<div class="span12"><?= $note->getContent() ?>
					<p class="clear"></p></div>
			</div>
		</div>
	<?php } ?>
