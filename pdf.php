...
function print_to_pdf($url, $filename, $orientation='Portrait', $staffId=null, $paperSize='A4', $noMargins=false)
{
	...
	$margins = !$noMargins ? "--margin-bottom 10mm --margin-top 10mm --margin-left 5mm  --margin-right 5mm" : " -d 96 -L 0mm -R 0mm -T 0mm -B 0mm --page-width 88mm --page-height 56mm " ;
...
ob_clean();
if (!isset($_GET['page'])) {
	exit("error:Nothing found to print");
}
require_once $_SERVER['DOCUMENT_ROOT'] . '/functions/utils.php';
$orientation = !is_blank(@$_GET['orientation']) ? @$_GET['orientation'] : 'portrait';
$paperSize = !is_blank(@$_GET['paperSize']) ? @$_GET['paperSize'] : 'A4';
